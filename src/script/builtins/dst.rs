...
use crate::{
    script::{
        unroll::{
            UnrolledExpression, UnrolledExpressionData, CompileContext, Function,
            FunctionOverload
        },
        parser::{
            Type, PredefinedType
...
fn dst_function_scalar() -> UnrolledExpression {
    UnrolledExpression {
        ty: Type::Predefined(PredefinedType::Scalar(Some(ComplexUnit::new(SimpleUnit::Scalar)))),
        span: span!(0, 0, 0, 0),
...
pub fn register_dst_function(context: &mut CompileContext) {
    context.functions.insert(String::from("dst"), Function {
        name: String::from("dst"),
        overloads: vec![
            FunctionOverload {
                returned_type: Type::Predefined(PredefinedType::Scalar(Some(ComplexUnit::new(SimpleUnit::Distance)))),
                definition_span: None,
                definition: dst_function_dst_convertible(),
                params: vec![Type::Predefined(PredefinedType::Scalar(Some(ComplexUnit::new(SimpleUnit::Distance))))]
            },
            FunctionOverload {
                returned_type: Type::Predefined(PredefinedType::Scalar(Some(ComplexUnit::new(SimpleUnit::Distance)))),
                definition_span: None,
                definition: dst_function_scalar(),
                params: vec![Type::Predefined(PredefinedType::Scalar(Some(ComplexUnit::new(SimpleUnit::Scalar))))]
            },
            FunctionOverload {
                returned_type: Type::Predefined(PredefinedType::Scalar(Some(ComplexUnit::new(SimpleUnit::Distance)))),
                definition_span: None,
